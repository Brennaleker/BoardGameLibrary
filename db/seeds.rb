board_games = [
  { title: 'Rococo', creator: 'Michael Menzel', image: File.open(File.join('app/assets/images/games/rococo.jpg')),
    ...
    min_players: 2, max_players: 5, min_time: 60, max_time: 120
    bgg_score: 7.143, expansion: false },
  { title: 'Marrying Mr. Darcy', creator: 'Erika Svanoe', image: File.open(File.join('app/assets/images/games/darcy.jpg')),
    ...
    min_players: 2, max_players: 6, min_time: 60, max_time: 60,
    bgg_score: 5.762, expansion: false },
  { title: 'Dominion', creator: 'Donald X. Vaccarino', image: File.open(File.join('app/assets/images/games/dominion.jpg')),
    ...
    bgg_score: 7.69, expansion: false },
  { title: 'Star Realms', creator: 'Robert Dougherty and Darwin Kastle', image: File.open(File.join('app/assets/images/games/star-realms.jpg')),
    ...
    bgg_score: , expansion: false },
  { title: 'Poo', creator: 'Matthew Grau', image: File.open(File.join('app/assets/images/games/poo.jpg')),
    ...
    min_players: 2, max_players: 8, min_time: 15, max_time: 15,
    bgg_score: , expansion: false }
]
